...
/*
/// Create a TCP socket using libc syscall().
/// Returns a raw file descriptor.
pub fn socket_tcp_libc() -> Result<i32, io::Error> {
...
/*
/// Connect a socket to an address using libc syscall().
...
/*
/// Write to a file descriptor using libc syscall().
